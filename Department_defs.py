    ...
    def barriers(self,t):
        if self.d["x " + str(t)] < self.d["vnumwall " + str(t)].get():
            while self.d["x " + str(t)] < self.d["vnumwall " + str(t)].get():
                ...
                self.d["titleresul {0}".format(str(self.d["x " + str(t)]))+self.d["nr "+str(t)]] = None
                ...
                self.d["radside {0}".format(str(self.d["x " + str(t)])+self.d["nr "+str(t)])]= None
                self.d["radforward {0}".format(str(self.d["x " + str(t)])+self.d["nr "+str(t)])]= None
                self.d["radiob_leak {0}".format(str(self.d["x " + str(t)]))+self.d["nr "+str(t)]] = IntVar(value=0)
                self.d["leak {0}".format(str(self.d["x " + str(t)])) + self.d["nr " + str(t)]] = None
                self.d["leakvar {0}".format(str(self.d["x " + str(t)]) + self.d["nr " + str(t)])] = IntVar(value=0)
                self.d["sellocation {0}".format(str(self.d["x " + str(t)]) + self.d["nr " + str(t)])] = None
                self.d["airkerv {0}".format(str(self.d["x " + str(t)]) + self.d["nr " + str(t)])] = IntVar(value=0)
                self.d["forw {0}".format(str(self.d["x " + str(t)])) + self.d["nr " + str(t)]] = None
                self.d["side {0}".format(str(self.d["x " + str(t)])) + self.d["nr " + str(t)]] = None
                self.d["laks {0}".format(str(self.d["x " + str(t)])+self.d["nr "+str(t)])]=None
                self.d["entk {0}".format(str(self.d["x " + str(t)])+self.d["nr "+str(t)])]=None
                #=========================barrier notebook============================================================================
                self.d["barrierf {0}".format(str(self.d["x " + str(t)]))+self.d["nr "+str(t)]] \
                    = ttk.Frame(self.d["noteb " + str(t)+self.d["nr "+str(t)]], width=180)
                self.d["barrierf " + str(self.d["x " + str(t)])+self.d["nr "+str(t)]].pack()
                if self.d["x " + str(t)] <= 3:
                    if self.d["x " + str(t)] == 1:
                        self.barn["lab_bar {0}".format(str(self.d["x " + str(t)])+self.d["nr "+str(t)])] = Label(text="Floor")
                        self.d["noteb " + str(t)+self.d["nr "+str(t)]].add(self.d["barrierf 1"+self.d["nr "+str(t)]], text="Floor")
                    elif self.d["x " + str(t)] == 2:
                        self.barn["lab_bar {0}".format(str(self.d["x " + str(t)])+self.d["nr "+str(t)])] \
                            = Label(text="Ceilng")
                        self.d["noteb " + str(t)+self.d["nr "+str(t)]].add(self.d["barrierf 2"+self.d["nr "+str(t)]], text="Ceilng")
                    else:
                        self.barn["lab_bar {0}".format(str(self.d["x " + str(t)])+self.d["nr "+str(t)])] = Label(text="Door")
                    ...
                    self.d["noteb " + str(t)+self.d["nr "+str(t)]].add(self.d["barrierf " + str(self.d["x " + str(t)])+self.d["nr "+str(t)]],
                                                  text="Barrier " + str(self.d["x " + str(t)] - 3))
                self.barr["{}".format(
                    self.barn["lab_bar " + str(self.d["x " + str(t)]) + self.d["nr " + str(t)]].cget("text"))] = 0
               #==============barrier type selection=================================
                self.d["label_B {0}".format(str(self.d["x " + str(t)]))] = ttk.Label(
                    master=self.d["barrierf " + str(self.d["x " + str(t)])
                                  +self.d["nr "+str(t)]], style="BL.TLabel", text="Select Barrier Type")
                self.d["label_B " + str(self.d["x " + str(t)])].grid(row=0, column=0, pady=10, padx=10, sticky="w")
                self.d["radiob_w {0}".format(str(self.d["x " + str(t)])+self.d["nr "+str(t)])] = IntVar(value=0)
                self.d["radpw {0}".format(str(self.d["x " + str(t)])+self.d["nr "+str(t)])] = ttk.Radiobutton(
                    master=self.d["barrierf " + str(self.d["x " + str(t)])+self.d["nr "+str(t)]],
                    variable=self.d["radiob_w " + str(self.d["x " + str(t)])+self.d["nr "+str(t)]], text="Primary Barrier", value=1,
                    command=lambda e=self.d["x " + str(t)],nr=self.d["nr "+str(t)]: self.barrier_sel(e,nr,t))
                self.d["radpw " + str(self.d["x " + str(t)])+self.d["nr "+str(t)]].grid(row=1, column=0, pady=10, padx=10, sticky="w")
                self.d["radsw {0}".format(str(self.d["x " + str(t)])+self.d["nr "+str(t)])] = ttk.Radiobutton(
                    master=self.d["barrierf " + str(self.d["x " + str(t)])+self.d["nr "+str(t)]],
                    variable=self.d["radiob_w " + str(self.d["x " + str(t)])+self.d["nr "+str(t)]], text="Secondary Barrier", value=2,
                    command=lambda e=self.d["x " + str(t)],nr=self.d["nr "+str(t)]: self.barrier_sel(e,nr,t))
                self.d["radsw " + str(self.d["x " + str(t)])+self.d["nr "+str(t)]].grid(row=1, column=1, pady=10, padx=10, sticky="w")
                #===================distance from source====================
                self.lad = ttk.Label(master=self.d["barrierf " + str(self.d["x " + str(t)])+self.d["nr "+str(t)]], style="AL.TLabel",
                                     text="Distance from the Source (m):")
                self.lad.grid(row=7, column=0, pady=10, padx=10, sticky="w")
                self.d["entryd {0}".format(str(self.d["x " + str(t)]))+self.d["nr "+str(t)]] = ttk.Entry(
                    master=self.d["barrierf " + str(self.d["x " + str(t)])+self.d["nr "+str(t)]], width=10)
                self.d["entryd " + str(self.d["x " + str(t)])+self.d["nr "+str(t)]].grid(row=7, column=1, pady=10, padx=10, sticky="w")
                #===============Materials selection===============
                self.d["m {0}".format(str(self.d["x " + str(t)])) + self.d["nr "+str(t)]] = 0  # Για το Spinbox του material
                self.matlab = ttk.Label(master=self.d["barrierf " + str(self.d["x " + str(t)])+self.d["nr "+str(t)]], style="AL.TLabel",
                                     text="Select Materials:")
                self.matlab.grid(row=8, column=0, padx=10,pady=10, sticky="w")

                self.d["vnumbmat {0}".format(str(self.d["x " + str(t)]))+self.d["nr "+str(t)]]=IntVar(value=1)
                self.d["numbmat {0}".format(str(self.d["x " + str(t)]))+self.d["nr "+str(t)]]= ttk.Spinbox(
                    master=self.d["barrierf " + str(self.d["x " + str(t)])+self.d["nr "+str(t)]], from_=1 ,to=6, width=5,
                    textvariable=self.d["vnumbmat " +str(self.d["x " + str(t)])+self.d["nr "+str(t)]] ,
                    command=lambda e=self.d["x " + str(t)],nr=self.d["nr "+str(t)] : self.numbmater(e,nr,t))
                self.d["numbmat "+ str(self.d["x " + str(t)]) + self.d["nr "+str(t)]].grid(row=8, column=1, padx=10,pady=10, sticky="w")
                ...
                if self.d["vselroom {0}".format(str(t))].get()=="X-Ray room":
                    ...
                    self.title_ocupat = ttk.Label(
                        master=self.d["barrierf " + str(self.d["x " + str(t)]) + self.d["nr " + str(t)]], style="BL.TLabel",
                        text="Shielding Area")
                    self.title_ocupat.grid(row=13, column=0, pady=10, padx=10, sticky="w")
                    # =========Classify area=============
                    self.d["area {0}".format(str(self.d["x " + str(t)]))+self.d["nr "+str(t)]] = StringVar()
                    self.d["area {0}".format(str(self.d["x " + str(t)]))+self.d["nr "+str(t)]] = ttk.Combobox(
                        master=self.d["barrierf " + str(self.d["x " + str(t)]) + self.d["nr " + str(t)]],
                        textvariable=self.d["area " + str(self.d["x " + str(t)])+self.d["nr "+str(t)]],
                        values=["Cotrolled Area", "Uncontrolled Area", "Supervised Area"], state="readonly")
                    self.d["area " + str(self.d["x " + str(t)])+self.d["nr "+str(t)]].grid(row=13, column=1, sticky="w")
                    self.d["area {0}".format(str(self.d["x " + str(t)]))+self.d["nr "+str(t)]].set("Classify the area")
                    self.d["vraoccup {0}".format(str(self.d["x " + str(t)]))+self.d["nr "+str(t)]] = IntVar(value=0)
                    self.raoccup = ttk.Radiobutton(
                        master=self.d["barrierf " + str(self.d["x " + str(t)]) + self.d["nr " + str(t)]],
                        variable=self.d["vraoccup " + str(self.d["x " + str(t)])+self.d["nr "+str(t)]], text="Write occupancy factor (T):",
                    ...
                    self.raseloccup = ttk.Radiobutton(
                        ...
                        variable=self.d["vraoccup " + str(self.d["x " + str(t)])+self.d["nr "+str(t)]], value=2,
                    ...
                    # ========Design Kerma Goal===========
                    self.ladike = ttk.Label(master=self.d["barrierf " + str(self.d["x " + str(t)]) + self.d["nr " + str(t)]], style="AL.TLabel",
                                            text="Design Kerma Goal (mGy/week):")
                    self.ladike.grid(row=16, column=0, pady=10, padx=10, sticky="w")
                    self.d["dikeent {0}".format(str(self.d["x " + str(t)]))+self.d["nr "+str(t)]] = ttk.Entry(master=self.d["barrierf " + str(self.d["x " + str(t)]) + self.d["nr " + str(t)]], width=10)
                    self.d["dikeent " + str(self.d["x " + str(t)])+self.d["nr "+str(t)]].grid(row=16, column=1, pady=10, padx=10, sticky="w")
                    # ==========
                elif self.d["vselroom {0}".format(str(t))].get()=="From X-Ray room":
                    self.d["selxroom {0}".format(str(self.d["x " + str(t)]))+self.d["nr "+str(t)]] = None
                    # ========Workload===========
                    self.title_workload = ttk.Label(master=self.d["barrierf " + str(self.d["x " + str(t)]) + self.d["nr " + str(t)]], style="BL.TLabel",
                                                    text="Workload")
                    self.title_workload.grid(row=13, column=0, pady=10, padx=10, sticky="w")
                    # =========X-ray Rooms============
                    self.xrayLabel = ttk.Label(master=self.d["barrierf " + str(self.d["x " + str(t)]) + self.d["nr " + str(t)]],
                                               text="Select X-Ray room or give tube kVp")
                    self.xrayLabel.grid(row=14, column=0, padx=10, pady=10, sticky="w")
                    # ======X-ray Room or kVp==========
                    self.d["vselxray {0}".format(str(self.d["x " + str(t)]))+self.d["nr "+str(t)]] = IntVar(value=0)
                    self.d["selxray1 {0}".format(str(self.d["x " + str(t)]))+self.d["nr "+str(t)]] = ttk.Radiobutton(master=self.d["barrierf " + str(self.d["x " + str(t)]) + self.d["nr " + str(t)]],
                                                                            variable=self.d["vselxray "+str(self.d["x " + str(t)])+self.d["nr "+str(t)]],
                                                                            text="Select X-Ray Room", value=1,
                                                                            command=lambda e=self.d["x " + str(t)], nr=self.d["nr "+str(t)]: self.XrRoom1(e,nr,t))
                    self.d["selxray1 "+ str(self.d["x " + str(t)])+self.d["nr "+str(t)]].grid(row=15, column=0, pady=10, padx=10, sticky="w")

                    self.d["selxray2 {0}".format(str(self.d["x " + str(t)]))+self.d["nr "+str(t)]] = ttk.Radiobutton(master=self.d["barrierf " + str(self.d["x " + str(t)]) + self.d["nr " + str(t)]],
                                                                            variable=self.d["vselxray "+str(self.d["x " + str(t)])+self.d["nr "+str(t)]],
                                                                            text="Give kVp", value=2,
                                                                            command=lambda e=self.d["x " + str(t)], nr=self.d["nr "+str(t)]: self.XrRoom1(e,nr, t))
                    self.d["selxray2 " + str(self.d["x " + str(t)])+self.d["nr "+str(t)]].grid(row=15, column=1, pady=10, padx=10, sticky="w")

                    # =====================Write workload========================
                    self.d["worentry {0}".format(str(self.d["x " + str(t)]))+self.d["nr "+str(t)]] = None
                    self.d["numpapwe {0}".format(str(self.d["x " + str(t)]))+self.d["nr "+str(t)]] = None
                    self.d["vrawork {0}".format(str(self.d["x " + str(t)]))+self.d["nr "+str(t)]] = IntVar(value=0)
                    self.raworkl = ttk.Radiobutton(master=self.d["barrierf " + str(self.d["x " + str(t)]) + self.d["nr " + str(t)]],
                                                   variable=self.d["vrawork " +str(self.d["x " + str(t)])+self.d["nr "+str(t)]],
                    ...
                    self.ranumb = ttk.Radiobutton(master=self.d["barrierf " + str(self.d["x " + str(t)]) + self.d["nr " + str(t)]],
                                                  text="or the number of patients per week:",
                                                  variable=self.d["vrawork " +str(self.d["x " + str(t)])+self.d["nr "+str(t)]], value=2,
                                                  command=lambda e=self.d["x " + str(t)], nr=self.d["nr "+str(t)]: self.workload2(e, nr, t))
                    self.ranumb.grid(row=18, column=0, pady=10, padx=10, sticky="w")
                #============Calculation Button====================
                self.d["calbutton {0}".format(str(self.d["x " + str(t)]))] \
                    = ttk.Button(master=self.d["barrierf " + str(self.d["x " + str(t)])+self.d["nr "+str(t)]], text="Calculate",
            ...
            while self.d["x " + str(t)] > self.d["vnumwall " + str(t)].get():
                self.d["barrierf " + str(self.d["x " + str(t)])+self.d["nr "+str(t)]].destroy()
                self.d["label_B " + str(self.d["x " + str(t)])].destroy()
                self.d["radpw " + str(self.d["x " + str(t)])+self.d["nr "+str(t)]].destroy()
                self.d["radsw " + str(self.d["x " + str(t)])+self.d["nr "+str(t)]].destroy()
                self.d["x " + str(t)] -= 1
