...
style = ttk.Style()
style.configure(root, background="#d5e0d7")



class App(ddepartment,dep_defs,departprimsec,dqprimsec,dquick,droom):
    ...
    def __init__(self, master):
        ...
        self.style.configure("TButton", background="#d5e0d7", foreground='#171a24', font="calibri 12")
        self.style.configure("AL.TButton", background="#2c3b47", foreground='#171a24', font="calibri 13")
        self.style.configure("TFrame", background="#d5e0d7", foreground="#d5e0d7")
        self.style.configure("ML.TFrame", background="#2c3b47", foreground="#171719")
        self.style.configure("AL.TNotebook", background="#2c3b47", foreground="#d5e0d7")
        self.style.configure("BL.TNotebook", background="#d5e0d7", foreground="#d5e0d7")
        self.style.configure("BL.TLabel", background="#d5e0d7", foreground='#171719', font='Helvetica 14',
                             weight='bold')
        self.style.configure("CL.TLabel", background="#2c3b47", foreground='#f6f8f8', font='Helvetica 14',
                             weight='bold')
        self.style.configure("AL.TLabel", background="#d5e0d7", foreground='#171719', font='Helvetica 12')

        self.style.configure("TLabel", background="#d5e0d7", foreground='#171719', font='Helvetica 12')
        self.style.configure("TRadiobutton", background="#d5e0d7", foreground='#171719', font='Helvetica 11')
        self.style.configure("TCheckbutton", background="#d5e0d7", foreground='#171719', font='Helvetica 11')
        self.style.configure("TSpinbox", background="#d5e0d7", foreground='#000000', font='Helvetica 11')
        self.style.configure("TCombobox", background="#d5e0d7", foreground='#000000', font='Helvetica 11')
        self.style.configure("TMenubutton", background="#ffffff", foreground='#000000', font='Helvetica 9')
        self.style.configure("TScrollbar", background="#d5e0d7", foreground="#d5e0d7")
